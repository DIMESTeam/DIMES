...
def args_parser():
    ...
    parser.add_argument('--te_greedy_size', type = int, help = 'greedy size for finding solutions')
...
def args_to_cmd(args, delim = ' \\\n    ', end = '\n'):
    return delim + delim.join(f'{k} {v}' for k, v in args_to_list(args)) + end
